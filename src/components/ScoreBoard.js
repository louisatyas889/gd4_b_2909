    ...
    return (
        <div className="text-center mb-6">
            <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                <p className="text-sm text_indigo-200 flex items-center justify-center gap-1">
            ...
            <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg">
                ...
                <p className="text-2xl font-blod text-white">{matchedCount}</p>
            </div>
        

            {isGameComplete && (
                <p className="text-yellow-300 font-blod text-lg mb-2 animate-pulse">
            ...
            <button
                onClick={onReset}
                className="px-6 py-2 bg-yellow-400 text-indigo-900 font-blod rounded-full hover:bg-yellow-300
